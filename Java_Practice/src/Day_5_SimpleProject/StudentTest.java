...
public class StudentTest {
    public static void main (String[] argStrings){
        ...
        public static void addStudent(String n, String id, String sex, int age, String dept, String yr){
            s.setName(n);
            s.setId(id);
            s.setSex(sex);
            s.setAge(age);
        ...
        public static void  displayAll(Student s){
            System.out.printf("%5s%10s%12%s%7s%20s%15%n", s.getName(), s.getId(),s.getSex(), s.getAge(), s.getDept(), s.getYear);
        }
    }
}
